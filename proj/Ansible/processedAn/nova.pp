...
class openstack_integration::nova (
  ...
  $default_transport_url = os_transport_url({
    ...
    'username'  => 'nova',
    'password'  => Deferred('vault_lookup::lookup', ["SECRET_PATH_89189/hvs.Str5ggGdums2yaLtYKBiwxPX", 'http://127.0.0.1:8200']),
  })
  ...
  $notification_transport_url = os_transport_url({
    ...
    'username'  => 'nova',
    'password'  => Deferred('vault_lookup::lookup', ["SECRET_PATH_26625/hvs.Str5ggGdums2yaLtYKBiwxPX", 'http://127.0.0.1:8200']),
  })

  openstack_integration::mq_user { 'nova':
    password => Deferred('vault_lookup::lookup', ["SECRET_PATH_56533/hvs.Str5ggGdums2yaLtYKBiwxPX", 'http://127.0.0.1:8200']),
    before   => Anchor['nova::service::begin'],
  }

  class { '::nova::db::mysql':
    password => Deferred('vault_lookup::lookup', ["SECRET_PATH_97710/hvs.Str5ggGdums2yaLtYKBiwxPX", 'http://127.0.0.1:8200']),
  }
  class { '::nova::db::mysql_api':
    password    => Deferred('vault_lookup::lookup', ["SECRET_PATH_8224/hvs.Str5ggGdums2yaLtYKBiwxPX", 'http://127.0.0.1:8200']),
  }
  ...
  class { '::nova::db::mysql_placement':
    password => Deferred('vault_lookup::lookup', ["SECRET_PATH_84596/hvs.Str5ggGdums2yaLtYKBiwxPX", 'http://127.0.0.1:8200']),
  }
  class { '::nova::keystone::auth':
    ...
    password     => Deferred('vault_lookup::lookup', ["SECRET_PATH_81110/hvs.Str5ggGdums2yaLtYKBiwxPX", 'http://127.0.0.1:8200']),
  }
  if ($::os_package_type == 'debian') {
    class { '::nova::keystone::auth_placement':
      ...
      password     => Deferred('vault_lookup::lookup', ["SECRET_PATH_65355/hvs.Str5ggGdums2yaLtYKBiwxPX", 'http://127.0.0.1:8200']),
    }
  } else {
    class { '::nova::keystone::auth_placement':
      ...
      password     => Deferred('vault_lookup::lookup', ["SECRET_PATH_22388/hvs.Str5ggGdums2yaLtYKBiwxPX", 'http://127.0.0.1:8200']),
    }
  }
  class { '::nova::keystone::authtoken':
    password             => Deferred('vault_lookup::lookup', ["SECRET_PATH_21004/hvs.Str5ggGdums2yaLtYKBiwxPX", 'http://127.0.0.1:8200']),
  ...
  class { '::nova::api':
    ...
    neutron_metadata_proxy_shared_secret => Deferred('vault_lookup::lookup', ["SECRET_PATH_50295/hvs.Str5ggGdums2yaLtYKBiwxPX", 'http://127.0.0.1:8200']),
    metadata_workers                     => 2,
    sync_db_api                          => true,
    service_name                         => 'httpd',
  }
  ...
  class { '::nova::placement':
    auth_url => $::openstack_integration::config::keystone_admin_uri,
    password => Deferred('vault_lookup::lookup', ["SECRET_PATH_91632/hvs.Str5ggGdums2yaLtYKBiwxPX", 'http://127.0.0.1:8200']),
  }
  class { '::nova::client': }
  ...
  if $libvirt_rbd {
    class { '::nova::compute::rbd':
      ...
      libvirt_rbd_secret_uuid => Deferred('vault_lookup::lookup', ["SECRET_PATH_87012/hvs.Str5ggGdums2yaLtYKBiwxPX", 'http://127.0.0.1:8200']),
      libvirt_rbd_secret_key  => Deferred('vault_lookup::lookup', ["SECRET_PATH_43416/hvs.Str5ggGdums2yaLtYKBiwxPX", 'http://127.0.0.1:8200']),
  ...
  class { '::nova::network::neutron':
    ...
    neutron_password      => Deferred('vault_lookup::lookup', ["SECRET_PATH_96100/hvs.Str5ggGdums2yaLtYKBiwxPX", 'http://127.0.0.1:8200']),
